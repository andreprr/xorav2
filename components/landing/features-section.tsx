...
const features = [
  {
    ...
    description: "Website company profile, katalog, hingga toko online sederhana. Desain profesional, cepat online, dan terhubung langsung ke WhatsApp.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Business Management",
    description: "Solusi digital untuk mengelola bisnis Anda. Rapikan operasional, katalog produk, dan data pelanggan dalam satu sistem yang mudah digunakan.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Custom Digital Solution",
    description: "Kebutuhan khusus? Kami rancang solusi digital sesuai alur bisnis Anda, dari fitur pemesanan hingga integrasi yang Anda butuhkan.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Aman & Bergaransi",
    description: "SSL, hosting terkelola, backup berkala, dan garansi. Website Anda aman, cepat, dan didukung tim yang siap membantu.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">Untuk setiap bisnis.</span>
          </h2>
        </div>
